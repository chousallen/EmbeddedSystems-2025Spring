...
//	int i = 0;
//	for(i = SAMPLE_BUFFER_SIZE / 2; i < SAMPLE_BUFFER_SIZE; ++i) printf("%d ", sample_buffer[i]);
//	printf("\n");
	osThreadFlagsSet(myTask02Handle, 0x0001);
}
...
void HAL_ADC_ConvHalfCpltCallback(ADC_HandleTypeDef *hadc)
{
    	//to do: inform RTOS task to print out sensor data
//	int i = 0;
//	for(i = 0; i < SAMPLE_BUFFER_SIZE / 2; ++i) printf("%d ", sample_buffer[i]);
//	printf("\n");
	osThreadFlagsSet(defaultTaskHandle, 0x0001);
}
...
//	printf("Yeah1\n");
	...
	global = 1;
	for(i = 0; i < SAMPLE_BUFFER_SIZE / 2; ++i) printf("%d ", sample_buffer[i]);
	osThreadFlagsSet(defaultTaskHandle, 0x0000);
//    osDelay(1);
  }
  /* USER CODE END 5 */
}
...
//	printf("Yeah2\n");
	int i = 0;
	for(i = SAMPLE_BUFFER_SIZE / 2; i < SAMPLE_BUFFER_SIZE; ++i) printf("%d ", sample_buffer[i]);
	osThreadFlagsSet(myTask02Handle, 0x0000);
//    osDelay(1);
  }
