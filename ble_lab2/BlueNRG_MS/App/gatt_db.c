...
#define COPY_USER_CHAR_UUID(uuid_struct)			   COPY_UUID_128(uuid_struct,0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0a,0x0b,0x0c,0x0d,0x0e,0x0f)

uint16_t HWServW2STHandle, EnvironmentalCharHandle, AccGyroMagCharHandle;
uint16_t SWServW2STHandle, QuaternionsCharHandle, UserCharHandle;

/* UUIDS */
Service_UUID_t service_uuid;
Char_UUID_t char_uuid, user_char_uuid;
