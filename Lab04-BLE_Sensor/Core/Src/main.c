...
int16_t acc_data[3];
uint8_t test = 0;
uint16_t update_interval = 100; // 100ms
/* USER CODE END 0 */
...
int main(void)
{
  ...
  /* Create the thread(s) */
  /* creation of taskACC */
  taskACCHandle = osThreadNew(startACC, NULL, &taskACC_attributes);

  /* creation of taskBLE */
  taskBLEHandle = osThreadNew(startBLE, NULL, &taskBLE_attributes);
...
/* USER CODE BEGIN Header_startACC */
/**
* @brief Function implementing the taskACC thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_startACC */
void startACC(void *argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
...
/* USER CODE BEGIN Header_startBLE */
/**
* @brief Function implementing the taskBLE thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_startBLE */
void startBLE(void *argument)
{
  /* USER CODE BEGIN startBLE */
  /* Infinite loop */
  for(;;)
  {
